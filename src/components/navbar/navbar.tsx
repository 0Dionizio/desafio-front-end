...
export function Navbar() {
  return (
    <nav className=" flex flex-row h-36  items-center gap-8 bg-white  w-full p-8">
      ...
      <div className="hover:bg-neutral-color-1 rounded-lg cursor-pointer flex flex-row gap-2 w-1/4">
